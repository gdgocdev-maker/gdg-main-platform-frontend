...
export default function SignupProgress({ step }: SignupProgressProps) {
  return (
    <div className="absolute my-2 left-8.75 right-8.75 top-43.5 flex items-start justify-center gap-2.75 text-center text-xs font-medium md:left-17 md:right-17">
